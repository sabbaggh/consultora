...
function App() {
  ...
  return (
    <div className="flex-1 h-screen bg-gray-950 w-full">
      ...
      <div className='h-screen flex items-center justify-center w-full' id='inicio'>
      ...
      <div className='flex flex-row h-screen items-center justify-center w-full bg-gray-950 space-x-8' id='conocenos'>
